...
val ClipSyncTypography = Typography(
    headlineSmall = BaseText.copy(fontSize = 24.sp, lineHeight = 30.sp, fontWeight = FontWeight.SemiBold),
    titleLarge = BaseText.copy(fontSize = 22.sp, lineHeight = 28.sp, fontWeight = FontWeight.SemiBold),
    titleMedium = BaseText.copy(fontSize = 16.sp, lineHeight = 22.sp, fontWeight = FontWeight.SemiBold),
    titleSmall = BaseText.copy(fontSize = 14.sp, lineHeight = 20.sp, fontWeight = FontWeight.SemiBold),
    ...
    bodySmall = BaseText.copy(fontSize = 12.sp, lineHeight = 17.sp, fontWeight = FontWeight.Normal),
    ...
    labelSmall = BaseText.copy(fontSize = 11.sp, lineHeight = 15.sp, fontWeight = FontWeight.Medium),
)
